...
export const SetInterestedCountries = () => {
  // Navigation
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // }
    navigate("/home");
    toast.success(`Your signup is complete, welcome to Job Search.`, {
      position: "top-center",
      autoClose: 3000,
      transition: Bounce,
    });
        ...
        <form className="mx-auto" onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <div className="categories">
              <ul className="max-xsm:justify-normal justify-center max-sm:justify-center flex flex-wrap max-sm:text-sm font-medium text-[#A2A2A2] gap-4">
          ...
          <div className="flex justify-end gap-4 controls-button">
            <button
              onClick={() => navigate("/signup/set-skills")}
